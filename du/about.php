				...
				<div class="container-fluid">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 info-area-right">
							...
							<p>Organisasi mahasiswa (ormawa) adalah organisasi yang beranggotakan mahasiswa untuk mewadahi bakat, minat, dan potensi mahasiswa yang dilaksanakan di dalam kegiatan ko dan ekstrakurikuler.</p>
							<br>
							<p>
								Organisasi mahasiswa (ormawa) adalah organisasi yang beranggotakan mahasiswa untuk mewadahi bakat, minat, dan potensi mahasiswa yang dilaksanakan di dalam kegiatan ko dan ekstrakurikuler.
							</p><p> </p>
							<p>Bentuk berikutnya adalah Unit Kegiatan Mahasiswa yang biasanya disingkat UKM yaitu organisasi mahasiswa yang dibentuk sesuai kesamaan minat, baik dibidang olahraga, kepecintaalaman, seni, atau lainnya serta Badan Eksektif Mahasiswa (BEM) dan Dewan Mahasiswa (DEMA). </p>
						</div>
					</div>
				</div>	
			</section>
